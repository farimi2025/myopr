...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verifyCsrf()) {
        ...
        redirect(BASE_URL . '/modules/guru/tambah.php');
    }
    ...
    // Check duplicate no_pekerja
    if ($noPerkerja) {
        $cek = dbValue("SELECT id FROM guru WHERE no_pekerja=?", [$noPerkerja]);
    ...
    if (empty($errors)) {
        ...
        logAktiviti('tambah', 'guru', (int)$id, "Tambah guru: $nama");
        setFlash('success', "Guru <strong>$nama</strong> berjaya ditambah.");
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1"><i class="bi bi-person-plus me-2 text-primary"></i>Tambah Guru</h4>
...
<form method="POST" enctype="multipart/form-data" data-autosave="guru" novalidate>
    <?= csrfField() ?>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <label class="form-label fw-semibold d-block">Muat Naik Foto</label>
    ...
    <div class="d-flex gap-2 mt-4">
        <button type="submit" class="btn btn-primary px-4">
            <i class="bi bi-check-circle me-1"></i>Simpan Guru
        </button>
